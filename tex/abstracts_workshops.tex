...
{Oliver Brock (Technische Universität Berlin), Dmitry Berenson (WPI), Jim Mainprice (WPI), Maximo Roa (DLR), Clemens Eppner (Technische Universität Berlin)]
{
...
{Lydia Tapia (University of New Mexico), Juan Cort´s (LAAS/CNRS), Jianlin Jack Cheng (Missouri), Amarda Shehu (George Mason) Kasra Manavi (University of New Mexico)}
{
