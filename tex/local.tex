...
\newpage
\phantomsection \section{1st Floor Plan of Wheeler Hall}
\begin{figure}[h!]
\center
\includegraphics[height=0.6\textheight]{local_img/maps/first_floor.png}
\end{figure}

\newpage
\phantomsection \section{2nd Floor plan of Wheeler Hall}

\begin{figure}[h!]
\center
\includegraphics[height=0.6\textheight]{local_img/maps/second_floor.png}
\end{figure}

\newpage
\phantomsection \section{Basement Floor Plan of Wheeler Hall}
\begin{figure}[h!]
\center
\includegraphics[height=0.6\textheight]{local_img/maps/basement.png}
\end{figure}
