...
\begin{timetable}
  ...
  \event 2 {1100} {1200} {11:00 Talks}                        {\vspace{-0.5em}1 long + 5 short\\60~min}{H~0104}             {oralsession}
  \event 2 {1200} {1330} {12:00\\[0.2em]Lunch Break}          {90~min}                        {}                            {break}
  \event 2 {1330} {1500} {13:30 Talks}                        {\vspace{-0.5em}2 long + 6 short\\90~min}{H~0104}             {oralsession}
  ...
  \event 3 {1100} {1200} {11:00 Talks}                        {\vspace{-0.5em}1 long + 5 short\\60~min}{H~0104}             {oralsession}
...
\ifthenelse{\equal{\targetoutput}{online}}{   
   \newcommand{\addpaper}[5]{ 
       \href{http://roboticsproceedings.org/rss09/#3.pdf}{#1}
       & #2     
       & #4
   }  
}{}
...
09:55&5& \addpaper{Multi-Hypothesis Social Grouping and Tracking for Mobile Robots}{Matthias~Luber, Kai~Arras}{p01}{01}{}\\
&5& \addpaper{Audio based Relative Positioning System for a Swarm of Micro Air Vehicles}{Meysam Basiri, et al.}{p02}{02}{}\\%Felix Schill, Dario Floreano, Pedro Lima
&5& \addpaper{High Altitude Stereo Visual Odometry}{Michael~Warren, Ben~Upcroft}{p03}{03}{}\\
&5& \addpaper{Learning Semantic Maps from Natural Language Descriptions}{Matt~Walter, et~al.}{p04}{04}{}\\%Sachithra Hemachandra, Bianca Homberg, Stefanie Tellex, Seth Teller
&5& \addpaper{Toward Interactive Grounded Language Acquisition}{Thomas~Kollar, et~al.}{p05}{05}{}\\%Jayant Krishnamurthy, Grant Strimel, Manuela Veloso
...
11:25&5& \addpaper{Online Coverage by a Tethered Autonomous Mobile Robot in Planar Unknown Environments}{Iddo~Shnaps, Elon~Rimon}{p07}{07}{p07_supplementary.mp4}\\
&5& \addpaper{Quantitative Evaluation of Standing Stabilization Using Stiff and Compliant Actuators}{Jorhabib~Eljaik, et~al.}{p08}{08}{p08_supplementary.mp4}\\ %Jorhabib Eljaik, Marco Randazzo, Zhibin Li, Nikos Tsagarakis, Francesco Nori
&5& \addpaper{Metastability for High-Dimensional Walking Systems on Stochastically Rough Terrain}{Mehdi~Benallegue, Jean-Paul~Laumond}{p09}{09}{}\\
&5& \addpaper{An Exact Decentralized Cooperative Navigation Algorithm for Acoustically Networked Underwater Vehicles with Robustness to Faulty Communication: Theory and Experiment}{Jeffrey~Walls, Ryan~Eustice}{p10}{10}{}\\
&5& \addpaper{Dynamics, Control and Planning for Cooperative Manipulation of Payloads Suspended by Cables from Multiple Quadrotor Robots}{Koushil~Sreenath, Vijay~Kumar}{p11}{11}{p11_supplementary.mp4}\\
...
14:25&5& \addpaper{Deep Learning for Detecting Robotic Grasps}{Ian~Lenz, Honglak~Lee, Ashutosh~Saxena}{p12}{12}{}\\
&5& \addpaper{Receding Horizon Control in Dynamic Environments from Temporal Logic Specifications}{Alphan~Ulusoy, Michael~Marrazzo, Calin~Belta}{p13}{13}{p13_supplementary.mp4}\\
&5& \addpaper{On Provably Safe Obstacle Avoidance for Autonomous Robotic Ground Vehicles}{Stefan~Mitsch, Khalil~Ghorbal, Andre~Platzer}{p14}{14}{}\\
&5& \addpaper{Pregrasp Manipulation as Trajectory Optimization}{Jennifer~ King, et~al.}{p15}{15}{}\\ %Jennifer King, Matthew Klingensmith, Christopher Dellin, Mehmet Dogar, Prasanna Velagapudi, Nancy Pollard, Siddhartha Srinivasa
&5& \addpaper{The Influence of Motion Path and Assembly Sequence on Stability of Assemblies}{Sourav~Rakshit, Srinivas~Akella}{p16}{16}{}\\
...
16:00&5& \addpaper{Minimum Constraint Displacement Motion Planning}{Kris~Hauser}{p17}{17}{}\\
&5& \addpaper{Integrated Perception and Planning in the Continuous Space: A POMDP Approach}{Haoyu~Bai, Hsu~David, Wee~Sun~Lee}{p18}{18}{p18_supplementary.pdf}\\
&5& \addpaper{Active Bayesian Perception for Simultaneous Object Localization and Identification}{Nathan~Lepora, Uriel~Martinez-Hernandez, Tony~Prescott}{p19}{19}{}\\
&5& \addpaper{Gaussian Process-Based Decentralized Data Fusion and Active Sensing for Mobility-on-Demand System}{Jie~Chen, Kian~Hsiang~Low and Colin~Keng-Yan~Tan}{p20}{20}{}\\
...
09:55&5& \addpaper{Exploiting Urban Scenes for Vision-aided Inertial Navigation}{Dimitrios~Kottas, Stergios~Roumeliotis}{p21}{01}{p21_supplementary.mp4}\\
&5& \addpaper{Fast Interpolation and Time-Optimization on Implicit Contact Submanifolds}{Kris~Hauser}{p22}{02}{p22_supplementary.mp4}\\
...
&5& \addpaper{Generating Legible Motion}{Anca~Dragan, Siddhartha~Srinivasa}{p24}{04}{}\\
&5& \addpaper{Bayesian Fusion for Multi-Modal Aerial Images}{Alistair~Reid, Fabio~Ramos}{p25}{05}{}\\
...
11:25&5& \addpaper{Unsupervised intrinsic calibration of depth sensors via SLAM}{Alex~Teichman, Stephen~Miller, Sebastian~Thrun}{p27}{07}{p27_supplementary.avi}\\
&5& \addpaper{6-D manipulation with aerial towed-cable systems}{Montserra~Manubens, Didier~Devaurs, Lluis~Ros, Juan~Cort\'es}{p28}{08}{p28_supplementary.mov}\\
&5&  \addpaper{Automatic Online Calibration of Cameras and Lasers}{Jesse~Levinson, Sebastian~Thrun}{p29}{09}{p29_supplementary.mov}\\
&5&  \addpaper{Goal Assignment and Trajectory Planning for Large Teams of Aerial Robots}{Matthew~Turpin, et~al.}{p30}{10}{p30_supplementary.mp4}\\ % Kartik Mohta, Nathan Michael, Vijay Kumar
&5&  \addpaper{Finding Locally Optimal, Collision-Free Trajectories with Sequential Convex Optimization}{John~Schulman, et~al.}{p31}{11}{}\\% Alex Lee, Ibrahim Awwal, Henry Bradlow, Pieter Abbeel
...
14:20&5&  \addpaper{Infinite Latent Conditional Random Fields for Modeling Environments through Humans }{Yun~Jiang, Ashutosh~Saxena}{p34}{14}{p34_supplementary.pdf}\\
&5&  \addpaper{Real-Time Camera Tracking and 3D Reconstruction Using Signed Distance Functions}{Erik~Bylow, et al.}{p35}{15}{p35_supplementary.mp4}\\%Erik Bylow (Lund University), JÃ¼rgen Sturm (Technische UniversitÃ¤t MÃ¼nchen), Christian Kerl (Technische UniversitÃ¤t MÃ¼nchen), Fredrik Kahl (Lund University), Daniel Cremers (Technische UniversitÃ¤t MÃ¼nchen)
&5&  \addpaper{Grasp Moduli Spaces}{Florian~T.~Pokorny, Kaiyu~Hang, Danica~Kragic}{p36}{16}{p36_supplementary.mp4}\\
&5&  \addpaper{Keyframe-Based Visual-Inertial SLAM using Nonlinear Optimization}{Stefan~Leutenegger, et~al.}{p37}{17}{p37_supplementary.mp4}\\ % Stefan Leutenegger (ETH Zurich), Paul Furgale (ETH), Vincent Rabaud (Willow Garage), Margarita Chli (ETH), Kurt Konolige (Industrial Perception), Roland Siegwart (ETH Zurich)
&5&  \addpaper{Maximum Mean Discrepancy Imitation Learning}{Beomjoon~Kim, Joelle~Pineau}{p38}{18}{}\\
&5&  \addpaper{Perceiving, Learning, and Exploiting Object Affordances for Autonomous Pile Manipulation}{Dov~Katz, et~al.}{p39}{19}{p39_supplementary.mp4}\\ %Dov Katz (CMU), Arun Venkatraman (CMU), Moslem Kazemi (CMU), Drew Bagnell (), Anthony Stentz (CMU)
...
\hline\\
\timeemph{20:00}&& Banquet & at Kater Holzig \ifthenelse{\equal{\dailyscheduleonly}{true}}{ }{(see \nameref{sec:banquetinfo})}  &\\
\hline
\end{tabular}
\vfill
\begingroup
\footnotesize{\textbf{Errata:}\\ Talks of Julia Parrish and Rodney Brooks are swapped in the PDF booklet on the USB stick.}
\endgroup
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
...
09:55&5& \addpaper{Correct Software Synthesis for Stable Speed-Controlled Robotic Walking}{Neil~Dantam, et~al.}{p40}{01}{p40_supplementary.mp4}\\%Neil Dantam (Georgia Tech), Ayonga Hereid (Texas A&M University), Aaron Ames (Texas A&M University), Mike Stilman (Georgia Tech)
&5& \addpaper{Toward a Platform of Human-Like Fingertip Model in Haptic Environment for Studying Sliding Tactile Mechanism}{Anh-Van~Ho, Shinichi~Hirai}{p41}{02}{}\\
&5& \addpaper{Incremental Block Cholesky Factorization for Nonlinear Least Squares in Robotics}{Lukas~Polok}{p42}{03}{}\\ %Lukas Polok (BUT FIT), Viorela Ila (BUT FIT), Marek Solony (BUT FIT), Pavel Smrz (BUT FIT), Pavel Zemcik (BUT FIT)
&5& \addpaper{Convex Optimization of Nonlinear Feedback Controllers via Occupation Measures}{Anirudha~Majumdar, et~al.}{p43}{04}{}\\%Anirudha Majumdar (MIT), Ram Vasudevan (MIT), Mark Tobenkin (MIT), Russ Tedrake (MIT)
&5& \addpaper{Realtime Registration-Based Tracking via Approximate Nearest Neighbour Search}{Travis~Dick, et~al.}{p44}{05}{p44_supplementary.mp4}\\%Travis Dick (University of Alberta), Camilo Perez (University of Alberta), Martin Jagersand (University of Alberta), Azad Shademan (University of Alberta)
...
%W2S session:
11:25&5& \addpaper{Topological Approach to Using Cables to Separate and Manipulate Sets of Objects}{Soonkyum~Kim, et~al.}{p46}{07}{p46_supplementary.mp4}\\ %Soonkyum Kim (University of Pennsylvania), Subhrajit Bhattacharya (University of Pennslvania), Hordur Heidarsson (University of Southern California), Gaurav Sukhatme (University of Southern California), Vijay Kumar (University of Pennsylvania)
&5& \addpaper{Learning to Plan for Constrained Manipulation from Demonstrations}{Phillips~Mike, et~al.}{p47}{08}{}\\ %Phillips Mike (CMU), Victor Hwang (Carnegie Mellon University), Sachin Chitta (Willow Garage), Maxim Likhachev (Carnegie Mellon University)
&5& \addpaper{Incremental Semantically Grounded Learning from Demonstration}{Scott~Niekum, et~al.}{p48}{09}{p48_supplementary.mp4}\\ %Scott Niekum (University of Massachusetts), Sachin Chitta (Willow Garage), Andrew Barto (University of Massachusetts Amherst), Bhaskara Marthi (willow garage), Sarah Osentoski (Robert Bosch Corporation)
&5& \addpaper{Fast Scheduling of Multi-Robot Teams with Temporospatial Constraints}{Matthew~Gombolay, Ronald~Wilcox, Julie~Shah}{p49}{10}{}\\
&5& \addpaper{Adaptive Estimation of Measurement Bias in Three-Dimensional Field Sensors with Angular Rate Sensors: Theory and Comparative Experimental Evaluation}{Giancarlo~Troni, Louis~Whitcomb}{p50}{11}{}\\

\timeemph{12:00} &90& Lunch Break && \\

\timeemph{13:30} &45+10& \addtalk{Invited Talk: Neural Mechanisms of Spatial Navigation}{Neil~Burgess} \\
%W3S session:
14:25&5&  \addpaper{Stochastic Motion Planning for Robotic Information Gathering}{Geoffrey~Hollinger, Gaurav~Sukhatme}{p51}{12}{p51_supplementary.mp4}\\
&5&  \addpaper{Kinodynamic Planning in the Configuration Space via Velocity Interval Propagation}{Quang-Cuong~Pham, Yoshihiko~Nakamura}{p52}{13}{p52_supplementary.mp4}\\
&5&  \addpaper{Approximate Representations for Multi-Robot Control Policies that Maximize Mutual Information}{Benjamin~Charrow, Vijay~Kumar, Nathan~Michael}{p53}{14}{p53_supplementary.mp4}\\
&5&  \addpaper{Real-Time EMG driven Lower Limb Actuated Orthosis for Assistance As Needed Movement Strategy}{Walid~Hassani, Samer~Mohammed, Yacine~Amirat}{p54}{15}{}\\
&5&  \addpaper{A model of distributional handing interaction for a mobile robot}{Chao~Shi, et~al.}{p55}{16}{}\\ %Chao Shi (Osaka University, ATR), Masahiro Shiomi (ATR), Christian Smith (Royal Institute of Technology), Takayuki Kanda (ATR), Hiroshi Ishiguro (Osaka University, ATR)
