...
\begin{timetable}
  ...
  \event 3 {1800} {1930} {18:00 Reception}  	              {\vspace{1.5mm}90~min}          {\vspace{-0.7em}Wheeler Hall}        {event}
...
\begingroup
\footnotesize{\textbf{Note:} All the technical program will be in Room 150 Wheeler Hall; workshops, breakfast, coffee breaks and posters will be in Wheeler Hall.}
\endgroup
